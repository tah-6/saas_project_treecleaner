...
path.join(process.cwd(), "packages/backend/src/generated/prisma/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "packages/backend/src/generated/prisma/schema.prisma")
