  ...
  return (
    <div className="p-4 md:p-8 bg-gray-50 min-h-screen font-sans text-slate-800">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight">Subscription Analysis</h1>
          <p className="text-slate-500 mt-1 text-sm md:text-base">Manage and track your recurring expenses</p>
        </div>
        <button
          onClick={() => {
            resetForm();
          ...
          className="w-full md:w-auto bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2.5 px-5 rounded-lg shadow-md transition-all flex items-center justify-center gap-2"
        >
          <Plus size={18} />
          Add Subscription
        </button>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-amber-700 text-sm mt-1">
                ...
                {errorDetails && <span className="block mt-1 font-mono text-xs bg-amber-100 p-1 rounded break-all">{errorDetails}</span>}
              </p>
            </div>
          </div>
        </div>
